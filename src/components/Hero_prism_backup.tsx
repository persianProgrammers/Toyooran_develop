                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6 w-full">
                  ...
                  {categoryCards.map((card, idx) => {
                    ...
                    return (
                      ...
                      >
                        {/* Magic Spinning Glowing Borders (visible on hover) */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250%] h-[250%] bg-[conic-gradient(from_0deg_at_50%_50%,transparent_0%,transparent_75%,#FBBF24_100%)] animate-spin [animation-duration:3s] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250%] h-[250%] bg-[conic-gradient(from_0deg_at_50%_50%,transparent_0%,transparent_75%,#003F86_100%)] animate-spin [animation-duration:4s] opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-150" style={{ animationDirection: 'reverse' }} />
                               ...
                               {(() => {
                                 switch(card.id) {
                                   case 'machinery': return (
                                     <div className="relative w-10 h-10 sm:w-12 sm:h-12 rotate-45 border-[0.5px] border-white/20 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm group-hover:border-blue-400/60 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.3),inset_0_0_15px_rgba(255,255,255,0.1)] transition-all duration-700 group-hover:rotate-[135deg] flex items-center justify-center">
                                       <div className="absolute inset-1.5 border-[0.5px] border-white/10 group-hover:border-blue-400/50 transition-all duration-700 group-hover:-rotate-90" />
                                       <div className="w-2 h-2 bg-slate-500 group-hover:bg-blue-300 rounded-sm group-hover:shadow-[0_0_12px_rgba(59,130,246,1)] transition-all duration-700" />
                                     </div>
                                   );
                                   case 'ventilation': return (
                                     <div className="relative w-10 h-10 sm:w-12 sm:h-12 rotate-45 border-[0.5px] border-white/20 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm group-hover:border-amber-400/60 group-hover:shadow-[0_0_20px_rgba(251,191,36,0.2),inset_0_0_15px_rgba(255,255,255,0.1)] transition-all duration-700 group-hover:rotate-[225deg] flex items-center justify-center">
                                        <div className="absolute inset-2 rounded-full border border-dashed border-white/20 group-hover:border-amber-400/50 transition-all duration-700 group-hover:animate-spin" style={{ animationDuration: '4s' }} />
                                        <div className="w-1.5 h-1.5 bg-slate-500 group-hover:bg-amber-300 rounded-full group-hover:shadow-[0_0_10px_rgba(251,191,36,1)] transition-all duration-700" />
                                     </div>
                                   );
                                   case 'structure': return (
                                     <div className="relative w-10 h-10 sm:w-12 sm:h-12 rotate-45 border-[0.5px] border-white/20 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm group-hover:border-emerald-400/60 group-hover:shadow-[0_0_20px_rgba(16,185,129,0.2),inset_0_0_15px_rgba(255,255,255,0.1)] transition-all duration-700 group-hover:rotate-[45deg] flex items-center justify-center overflow-hidden">
                                        <div className="absolute w-full h-[1px] bg-white/10 group-hover:bg-emerald-400/40 transition-colors duration-700" />
                                        <div className="absolute h-full w-[1px] bg-white/10 group-hover:bg-emerald-400/40 transition-colors duration-700" />
                                        <div className="w-2.5 h-2.5 border-[1px] border-slate-500 group-hover:border-emerald-300 group-hover:shadow-[0_0_15px_rgba(16,185,129,0.8)_inset] transition-all duration-700 rotate-45" />
                                     </div>
                                   );
                          ...
                          <div className="relative z-20 mt-auto flex flex-col items-center text-center w-full">
                             ...
                             <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] w-full">
                                <div className="overflow-hidden flex flex-col items-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 w-full">
                                  <p className="text-[11px] sm:text-xs text-slate-400 line-clamp-2 leading-relaxed mb-4 px-2 font-medium">
                                    {card.desc}
                                  </p>
                                  <div className="flex items-center gap-1.5 text-xs font-bold text-amber-400 bg-amber-400/10 px-4 py-2 rounded-xl border border-amber-400/20 shadow-[0_0_15px_rgba(251,191,36,0.15)] pointer-events-auto cursor-pointer mb-1">
